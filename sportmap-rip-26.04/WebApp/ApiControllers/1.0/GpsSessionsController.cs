...
namespace WebApp.ApiControllers._1._0
{
    ...
    public class GpsSessionsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<V1DTO.GpsSessionView>>> GetGpsSessions()
        {
            var result = await _bll.GpsSessions.GetAllForViewAsync();
        ...
        public async Task<ActionResult<V1DTO.GpsSession>> PostGpsSession(V1DTO.GpsSession gpsSession)
        {
            ...
            return CreatedAtAction("GetGpsSession",

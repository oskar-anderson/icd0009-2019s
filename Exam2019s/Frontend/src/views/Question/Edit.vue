        ...
        <div class="row">
            <div class="col-md-4">
                <form submit.trigger="onSubmit($event)">
                    ...
                    -->
                    <button @click="updateOnClick(getQuestion)" type="button" class="btn btn-primary">Submit</button>
                </form>
            </div>
        </div>
...
export default class QuestionEdit extends Vue {
    get getQuestion(): IQuestion {
        ...
        const questionNotFound : IQuestion = {
            id: "",
            quizId: "",
            orderNumber: 1,
            questionName: "",
        ...
        return question != null ? question : questionNotFound;
    };
    ...
    updateOnClick(question: IQuestion): void {
        ...
        store.dispatch('editQuestion', questionIntified);
    ...
    mounted(): void {
        ...
        store.dispatch("getQuestion", this.$route.params.id)
        console.log("mounted");
    }

...
namespace ee.itcollege.kaande.pitsariina.Contracts.DAL.Base.Repositories
{
        ...
        where TEntity : class, IDomainEntityId<TKey>, new()
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAllAsyncBase(object? userId = null, bool noTracking = true);

...
namespace ee.itcollege.kaande.pitsariina.DAL.Base.EF.Repositories
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public virtual async Task<IEnumerable<TDALEntity>> GetAllAsyncBase(object? userId = null, bool noTracking = true)
        {

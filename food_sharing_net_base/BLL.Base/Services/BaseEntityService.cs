...
namespace ee.itcollege.kaande.pitsariina.BLL.Base.Services
{
        ...
        where TMapper : IBaseMapper<TDALEntity, TBLLEntity>
    {
        ...
        public virtual async Task<IEnumerable<TBLLEntity>> GetAllAsyncBase(object? userId = null, bool noTracking = true)
        {
            var dalEntities = await Repository.GetAllAsyncBase(userId, noTracking);

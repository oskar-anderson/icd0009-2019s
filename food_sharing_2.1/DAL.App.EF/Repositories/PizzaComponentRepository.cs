...
{
    public class PizzaComponentRepository :  EFBaseRepository<AppDbContext,  Domain.PizzaComponent, DAL.App.DTO.PizzaComponent>, IPizzaComponentRepository
    {
        public PizzaComponentRepository(AppDbContext dbContext) : base(dbContext, new BaseDALMapper<Domain.PizzaComponent, DAL.App.DTO.PizzaComponent>())
        {
        }

...
{
    public class InvoiceLineRepository :  EFBaseRepository<AppDbContext, Domain.InvoiceLine, DAL.App.DTO.InvoiceLine>, IInvoiceLineRepository
    {
        public InvoiceLineRepository(AppDbContext dbContext) : base(dbContext, new BaseDALMapper<Domain.InvoiceLine, DAL.App.DTO.InvoiceLine>())
        {
        }

...
{
    public class CartMealRepository : EFBaseRepository<AppDbContext, Domain.CartMeal, DAL.App.DTO.CartMeal>, ICartMealRepository
    {
        public CartMealRepository(AppDbContext dbContext) : base(dbContext, new BaseDALMapper<Domain.CartMeal, DAL.App.DTO.CartMeal>())
        {
        }
        
        // methods go here

        public async Task<IEnumerable< DAL.App.DTO.CartMeal>> AllAsync(Guid? userId = null)
        {
            var query = RepoDbSet
        ...
        public async Task<DAL.App.DTO.CartMeal> FirstOrDefaultAsync(Guid id, Guid? userId = null)
        {
            var query = RepoDbSet
                .Include(cm => cm.PizzaFinal)
                .Include(cm => cm.Meal)

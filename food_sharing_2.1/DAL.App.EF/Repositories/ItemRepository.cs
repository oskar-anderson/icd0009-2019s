...
{
    public class ItemRepository : EFBaseRepository<AppDbContext,  Domain.Item, DAL.App.DTO.Item>, IItemRepository
    {
        public ItemRepository(AppDbContext dbContext) : base(dbContext, new BaseDALMapper<Domain.Item, DAL.App.DTO.Item>())
        {
        }

...
namespace WebApp.Controllers
{
    ...
    public class RestaurantFoodController : Controller
    {
        ...
        {
            ViewData[ViewDataIdConstants.MealId] = new SelectList(await _bll.Pizzas.GetAllAsyncBase(),
                ViewDataConstants.Id,
                ViewDataConstants.Name);
            ViewData[ViewDataIdConstants.PizzaId] = new SelectList(await _bll.Meals.GetAllAsyncBase(),
                ViewDataConstants.Id,
                ViewDataConstants.Name);

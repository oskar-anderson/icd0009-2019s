...
namespace DAL.App.EF.Repositories
{
    public class PizzaComponentRepository : 
        EFBaseRepository<AppDbContext, AppUser, Domain.App.PizzaComponent, DTO.PizzaComponent>, 
        IPizzaComponentRepository
    {
        public PizzaComponentRepository(AppDbContext dbContext) : base(dbContext, 
            new BaseMapper<Domain.App.PizzaComponent, DTO.PizzaComponent>())
        {
        }

        public async Task<IEnumerable<PizzaComponent>> GetAllAsync(Guid id, Guid? userId = null, bool noTracking = true)
        {
            var query = RepoDbSet
        ...
        public virtual async Task<IEnumerable<PizzaComponent>> GetAllForViewAsync()
        {
            ...
            return await query
                .Select(pc => new PizzaComponent()
                {
                    ...
                    PizzaTemplate = new PizzaTemplate()
                    {
                        Id = pc.PizzaTemplate.Id,
                        CategoryId = pc.PizzaTemplate.CategoryId,
                        Category = new Category()
                        {
                            Id = pc.PizzaTemplate.Category.Id,
                            Name = pc.PizzaTemplate.Category.Name,
                        },
                        Name = pc.PizzaTemplate.Name,
                        Picture = pc.PizzaTemplate.Picture,
                        Modifications = pc.PizzaTemplate.Modifications,
                        Extras = pc.PizzaTemplate.Extras,
                        Description = pc.PizzaTemplate.Description,
                    }
                })
                .ToListAsync();
        }

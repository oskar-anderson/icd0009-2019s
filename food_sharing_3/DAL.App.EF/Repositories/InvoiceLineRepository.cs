...
namespace DAL.App.EF.Repositories
{
    public class InvoiceLineRepository : 
        EFBaseRepository<AppDbContext, AppUser, Domain.App.InvoiceLine, InvoiceLine>, 
        IInvoiceLineRepository
    {
        public InvoiceLineRepository(AppDbContext dbContext) : base(dbContext, 
            new BaseMapper<Domain.App.InvoiceLine, InvoiceLine>())
        {
        }

        public async Task<IEnumerable<InvoiceLine>> GetAllAsync(Guid id, Guid? userId = null, bool noTracking = true)
        {
            var query = RepoDbSet
                .Include(a => a.Invoice)
                .Include(a => a.Cart)

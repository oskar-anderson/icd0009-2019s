...
namespace WebApp.ApiControllers._1._0
{
    ...
    public class GpsLocationTypesController : ControllerBase
    {
        ...
        {
            return Ok((await _bll.GpsLocationTypes.GetAllAsyncBase()).Select(e => _mapper.Map(e)));
        }
        ...
        {
            var gpsLocationType = await _bll.GpsLocationTypes.FirstOrDefaultAsync(id);
        ...
        public async Task<IActionResult> PutGpsLocationType(Guid id, V1DTO.GpsLocationType gpsLocationType)
        {
            ...
            await _bll.GpsLocationTypes.UpdateAsync(_mapper.Map(gpsLocationType));
            ...
            V1DTO.GpsLocationType gpsLocationType)
        {
            ...
            _bll.GpsLocationTypes.Add(bllEntity);
            await _bll.SaveChangesAsync();
        ...
        public async Task<ActionResult<V1DTO.GpsLocationType>> DeleteGpsLocationType(Guid id)
        {
            ...
            await _bll.GpsLocationTypes.RemoveAsync(gpsLocationType);
            await _bll.SaveChangesAsync();
